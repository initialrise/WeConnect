...
namespace WeConnect.Migrations
{
    ...
    [Migration("20230829011509_SeedThreads")]
    partial class SeedThreads
    {
            ...
            modelBuilder.Entity("WeConnect.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("ThreadSubscribedId")
                        .HasColumnType("int");

                    b.Property<int>("Turegno")
                        .HasColumnType("int");

                    b.HasIndex("ThreadSubscribedId");
            ...
            modelBuilder.Entity("WeConnect.Models.ApplicationUser", b =>
                {
                    b.HasOne("WeConnect.Models.Threads", "ThreadSubscribed")
                        .WithMany()
                        .HasForeignKey("ThreadSubscribedId");
